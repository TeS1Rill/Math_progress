...
public class Level_12 extends AppCompatActivity {
    ...
    private Button button_dialog_level_12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_12);
        ...
        onInfoLevels();
        onBackDialogLevel_12();
        onContinDialog_level_12();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_12.this, R.anim.alpha);

        num_1 = random.nextInt(10);
        imageView_1.setImageResource(array.array_level_12[num_1]);
        num_2 = random.nextInt(10);
        while (num_1 == num_2){
            num_2 = random.nextInt(10);
        }
        imageView_2.setImageResource(array.array_level_12[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_12.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_12);
    }
    private void onContinDialog_level_12(){
        button_dialog_level_12 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_12.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_12(){

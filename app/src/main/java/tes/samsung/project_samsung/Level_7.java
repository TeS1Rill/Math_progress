...
public class Level_7 extends AppCompatActivity {
    ...
    private Button button_dialog_level_7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_7);
        ...
        onInfoLevels();
        onBackDialogLevel_7();
        onContinDialog_level_7();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_7.this, R.anim.alpha);

        num_1 = random.nextInt(11);
        imageView_1.setImageResource(array.array_level_7[num_1]);
        num_2 = random.nextInt(11);
        while (num_1 == num_2){
            num_2 = random.nextInt(11);
        }
        imageView_2.setImageResource(array.array_level_7[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_7.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_7);
    }
    private void onContinDialog_level_7(){
        button_dialog_level_7 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_7.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_7(){

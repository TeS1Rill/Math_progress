...
public class Level_5 extends AppCompatActivity {
    ...
    private Button button_dialog_level_5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_5);
        ...
        onInfoLevels();
        onBackDialogLevel_5();
        onContinDialog_level_5();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_5.this, R.anim.alpha);

        num_1 = random.nextInt(12);
        imageView_1.setImageResource(array.array_level_5[num_1]);
        num_2 = random.nextInt(12);
        while (num_1 == num_2){
            num_2 = random.nextInt(12);
        }
        imageView_2.setImageResource(array.array_level_5[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_5.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_5);
    }
    private void onContinDialog_level_5(){
        button_dialog_level_5 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_5.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_5(){

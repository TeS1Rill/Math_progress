...
public class Level_13 extends AppCompatActivity {
    ...
    private Button button_dialog_level_13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_13);
        ...
        onInfoLevels();
        onBackDialogLevel_13();
        onContinDialog_level_13();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_13.this, R.anim.alpha);

        num_1 = random.nextInt(8);
        imageView_1.setImageResource(array.array_level_13[num_1]);
        num_2 = random.nextInt(8);
        while (num_1 == num_2){
            num_2 = random.nextInt(8);
        }
        imageView_2.setImageResource(array.array_level_13[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_13.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_13);
    }
    private void onContinDialog_level_13(){
        button_dialog_level_13 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_13.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_13(){

...
public class Level_4 extends AppCompatActivity {
    ...
    private Button button_dialog_level_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_4);
        ...
        onInfoLevels();
        onBackDialogLevel_4();
        onContinDialog_level_4();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_4.this, R.anim.alpha);

        num_1 = random.nextInt(12);
        imageView_1.setImageResource(array.array_level_4[num_1]);
        num_2 = random.nextInt(12);
        while (num_1 == num_2){
            num_2 = random.nextInt(12);
        }
        imageView_2.setImageResource(array.array_level_4[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_4.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_4);
    }
    private void onContinDialog_level_4(){
        button_dialog_level_4 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_4(){

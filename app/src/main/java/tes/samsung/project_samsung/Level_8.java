...
public class Level_8 extends AppCompatActivity {
    ...
    private Button button_dialog_level_8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_8);
        ...
        onInfoLevels();
        onBackDialogLevel_8();
        onContinDialog_level_8();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_8.this, R.anim.alpha);

        num_1 = random.nextInt(10);
        imageView_1.setImageResource(array.array_level_8[num_1]);
        num_2 = random.nextInt(10);
        while (num_1 == num_2){
            num_2 = random.nextInt(10);
        }
        imageView_2.setImageResource(array.array_level_8[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_8.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_8);
    }
    private void onContinDialog_level_8(){
        button_dialog_level_8 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_8.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_8(){

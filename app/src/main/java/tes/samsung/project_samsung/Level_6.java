...
public class Level_6 extends AppCompatActivity {
    ...
    private Button button_dialog_level_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_level_6);
        ...
        onInfoLevels();
        onBackDialogLevel_6();
        onContinDialog_level_6();
        ///////

        final Animation anim = AnimationUtils.loadAnimation(Level_6.this, R.anim.alpha);

        num_1 = random.nextInt(11);
        imageView_1.setImageResource(array.array_level_6[num_1]);
        num_2 = random.nextInt(11);
        while (num_1 == num_2){
            num_2 = random.nextInt(11);
        }
        imageView_2.setImageResource(array.array_level_6[num_2]);
        ...
        buttub_back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(Level_6.this, Levels.class);
                        startActivity(i);
                        finish();
                    }
                }
    ...
    private void onInfoLevels(){
        ...
        text_info.setText(R.string.level_6);
    }
    private void onContinDialog_level_6(){
        button_dialog_level_6 = (Button) dialog.findViewById(R.id.button_dialog);
        button_dialog_level_6.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dialog.dismiss();
    ...
    private void onBackDialogLevel_6(){
